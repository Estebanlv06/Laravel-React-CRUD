            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <Card title="Descripción">
                        ...
                        <p className="mt-4"><strong>IMPORTANTE: eliminación en cascada disponible, pero sin mensaje de alerta.</strong></p>
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4">
                    <Card title="Proximas actualizaciones">
                        ...
                        <p class="mt-1">2. Filtros para bodegas o productos.</p>
                        <p class="mt-1">3. Alerta en caso de eliminación en cascada.</p>
                        <p class="mt-1">4. Cambio de logo.</p>
                    </Card>
                </div>
            </div>
        </AuthenticatedLayout>
